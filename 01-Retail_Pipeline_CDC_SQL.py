...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=7474644437762928&notebook=%2F01-Retail_Pipeline_CDC_SQL&demo_name=declarative-pipeline-cdc&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdeclarative-pipeline-cdc%2F01-Retail_Pipeline_CDC_SQL&version=1">
...
-- MAGIC
-- MAGIC Your pipeline has been created! You can directly access the <a dbdemos-pipeline-id="sdp-cdc" href="/#joblist/pipelines/13373fcc-bf33-4269-9690-4022140f8875">Spark Declarative Pipelines for CDC</a>.
...
-- MAGIC %md
-- MAGIC ### Conclusion 
-- MAGIC We now have <a dbdemos-pipeline-id="sdp-cdc" href="/#joblist/pipelines/13373fcc-bf33-4269-9690-4022140f8875">our Spark Declarative Pipelines</a> up & ready! Our `customers` table is materialize and we can start building BI report to analyze and improve our business. It also open the door to Data Science and ML use-cases such as customer churn, segmentation etc.
